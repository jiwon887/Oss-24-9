...
train_lable_paths = label_paths[:-test_samples]

test_img_paths = img_paths[-test_samples:]
test_lable_paths = label_paths[-test_samples:]

train_gen = OxfordPets(batch_siz, img_siz, train_img_paths, train_lable_paths)
test_gen = OxfordPets(batch_siz, img_siz, test_img_paths, test_lable_paths)
...
cv.imshow('Segmantation lable', cv.imread(test_lable_paths[0]) * 64)
